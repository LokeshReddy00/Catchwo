...
import com.buddies.catchwo.Filter.PostFilter;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.Holder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        String comt = arrayList.get(position).getComt();
        ...
        String cat = arrayList.get(position).getCat();
        ...
        if(cat.equals("mome")){
            FirebaseDatabase.getInstance().getReference().child("Users").child(uid).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    Glide.with(context).load(""+snapshot.child("pic").getValue()).placeholder(R.drawable.name).into(holder.user_img);

//                if(!snapshot.child("pic").getValue().equals(null)){
//                    Picasso.get().load(""+snapshot.child("pic").getValue()).placeholder(R.drawable.name).into(holder.user_img);
//
//                }else {
//                    holder.user_img.setImageResource(R.drawable.name);
//                }
...
//                    alert = new AlertDialog.Builder(context, R.style.BottomSheetDialogTheme);
//
//                } else {
//                    alert = new AlertDialog.Builder(context);
//                }
//
//                View view = LayoutInflater.from(context).inflate(R.layout.bottom_drop, null);
//
//
...
//                like_count_text.setText(snapshot.getChildrenCount() + " Likes");
    ...
    public Filter getFilter() {
        if(filter == null){
            filter = new PostFilter(this,FilterList);
        }
