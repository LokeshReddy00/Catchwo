...
import com.buddies.catchwo.Adapter.YourAppointInfoAdapter;
 ...
 * Use the {@link YourAppointFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class YourAppointFragment extends Fragment {
     ...
     * @return A new instance of fragment YourAppointFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static YourAppointFragment newInstance(String param1, String param2) {
        YourAppointFragment fragment = new YourAppointFragment();
    ...
    YourAppointInfoAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_your_appoint, container, false);

        app_his = view.findViewById(R.id.app_his);
        arrayList = new ArrayList<>();
        adapter = new YourAppointInfoAdapter(getActivity(),arrayList);
...
//                            String urlImage= "Image folder link"+image;
                            ...
                            if(uidto.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
